    ...
    <div class="app-body">
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          ...
          <div v-show="activeTab === 'background'" class="panel">
            <div class="form-item">
              <label>抠图方式</label>
          ...
          <div v-show="activeTab === 'adjust'" class="panel">
            <div class="form-item">
              <label>亮度</label>
          ...
          <div v-show="activeTab === 'layout'" class="panel">
            <div class="form-item">
              <label>排版预设</label>
          ...
          <div v-show="activeTab === 'export'" class="panel">
            <div class="form-item">
              <label>导出格式</label>
...
function createCropRect(width, height) {
  if (!hasImage.value || !mainImage) return
...
function handleMouseDown(opt) {
  if (!isManualCutoutMode.value || !mainImage) return
...
function handleMouseMove(opt) {
  if (!isDrawing || !isManualCutoutMode.value) return
...
function applyBorder() {
  if (!mainImage || borderWidth.value <= 0) return
